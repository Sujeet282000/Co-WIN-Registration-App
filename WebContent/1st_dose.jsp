...
<fieldset>
    <legend><h1>Book Slot for Vaccine 1st Dose </h1></legend>
  <form  action="servlet_1.jsp" method="get">
...
<div class="textbox">
<!-- <i class="fa fa-user" aria-hidden="true"></i>-->
<input type="text" name="user" placeholder="User_id" required><br>
</div>
...
<div >
<input class="btn" type="submit" name ="" value="Download Certificate of 1st dose">
</div>
</form>
</div>
...
<script>
function myFunction() {
  alert("you have successfully vaccinated 1st dose");
}
</script>
